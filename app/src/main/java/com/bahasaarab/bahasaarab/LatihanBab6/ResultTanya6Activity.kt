...
import com.bahasaarab.bahasaarab.LatihanBab5.LatihanTanya5Activity
import com.bahasaarab.bahasaarab.LatihanBab5.LatihanTitik5Activity
import com.bahasaarab.bahasaarab.R
import kotlinx.android.synthetic.main.activity_result_gambar.*

class ResultTanya6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_tanya6)
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultTanya6Activity, LatihanTanya6Activity::class.java)
            startActivity(i)
            finish()
        })

        notif.setOnClickListener {
            val intent = Intent(this@ResultTanya6Activity,
                LatihanTitik6Activity::class.java)
