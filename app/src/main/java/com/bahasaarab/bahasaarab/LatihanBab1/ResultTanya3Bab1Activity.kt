...
class ResultTanya3Bab1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_tanya3_bab1)
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultTanya3Bab1Activity, LatihanTanya3Bab1Activity::class.java)
            startActivity(i)
            finish()
        })

        notif.setOnClickListener {
            val intent = Intent(this@ResultTanya3Bab1Activity,
                LatihanTitikActivity::class.java)
