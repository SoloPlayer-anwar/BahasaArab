...
class LatihanTanya3Bab1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_latihan_tanya3_bab1)
        ...
        proses!!.setOnClickListener(View.OnClickListener {
            ...
            if (value_no1!!.text.toString().toLowerCase() == "تَاجِرَةٌ") {
                nilai = nilai + 20
            }
            if (value_no2!!.text.toString().toLowerCase() == "حَلِيْمَة") {
                nilai = nilai + 20
            }
            if (value_no3!!.text.toString().toLowerCase() == "الْمَلاَبِسِ") {
                nilai = nilai + 20
            }
            if (value_no4!!.text.toString().toLowerCase() == "تَاجِرَةٌ") {
                nilai = nilai + 20
            }
            if (value_no5!!.text.toString().toLowerCase() == "مَاهِرٌ") {
                nilai = nilai + 20
            }
            val i = Intent(this@LatihanTanya3Bab1Activity, ResultTanya3Bab1Activity::class.java)
    ...
    private fun showDialogTanya3() {

        myDialog = Dialog(this)
        myDialog.requestWindowFeature(Window.FEATURE_NO_TITLE)
        myDialog.setContentView(R.layout.bantuan_tanya3_bab1_activity)
