...
class ResultTitikActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_titik)
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultTitikActivity, LatihanTitikActivity::class.java)
            startActivity(i)
            finish()
        })
