...
class LatihanTitikActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_latihan_titik)
        ...
        proses!!.setOnClickListener(View.OnClickListener {
            ...
            if (value_no1!!.text.toString().toLowerCase() == "محمود") {
                nilai = nilai + 20
            }
            if (value_no2!!.text.toString().toLowerCase() == "بَنْجَرْمَاسِيْن") {
                nilai = nilai + 20
            }
            if (value_no3!!.text.toString().toLowerCase() == "طَالِبٌ") {
                nilai = nilai + 20
            }
            if (value_no4!!.text.toString().toLowerCase() == "زَمِيْلِيْ") {
                nilai = nilai + 20
            }
            if (value_no5!!.text.toString().toLowerCase() == "مَدِيْنَةِ") {
                nilai = nilai + 20
            }
            val i = Intent(this@LatihanTitikActivity, ResultTitikActivity::class.java)
    ...
    fun ShowDialog() {
        ...
        myDialog.setContentView(R.layout.bantuan_titik_activity)
