...
class LatihanTanyaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_latihan_tanya)
        ...
        proses!!.setOnClickListener(View.OnClickListener {
            ...
            if (value_no1!!.text.toString().toLowerCase() == "أَنَا طَالِبٌ") {
                nilai = nilai + 20
            }
            if (value_no2!!.text.toString().toLowerCase() == "أَنَا مِنْ بَنْجَرْمَاسِيْن") {
                nilai = nilai + 20
            }
            if (value_no3!!.text.toString().toLowerCase() == "أَنَا أَدْرُسُ فِى كُلِّيَّةِ الإِقْتِصَادِ") {
                nilai = nilai + 20
            }
            if (value_no4!!.text.toString().toLowerCase() == "هُوَ زَمِيْلِيْ") {
                nilai = nilai + 20
            }
            if (value_no5!!.text.toString().toLowerCase() == "هُوَ مِنْ مَدِيْنَةِ سُوْرَابَايَا") {
                nilai = nilai + 20
            }
            val i = Intent(this@LatihanTanyaActivity, ResultTanyaActivity::class.java)
     ...
     fun ShowDialog() {
         ...
         myDialog.setContentView(R.layout.bantuan_tanya_activity)
