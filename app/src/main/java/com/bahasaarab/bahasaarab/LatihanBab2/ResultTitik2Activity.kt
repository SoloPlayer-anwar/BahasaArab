...
class ResultTitik2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_titik2)
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultTitik2Activity, LatihanTitik2Activity::class.java)
            startActivity(i)
            finish()
        })
