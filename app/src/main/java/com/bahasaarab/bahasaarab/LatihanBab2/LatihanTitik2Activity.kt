...
import com.bahasaarab.bahasaarab.LatihanBab1.ResultTitikActivity
import com.bahasaarab.bahasaarab.R

class LatihanTitik2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_latihan_titik2)
        ...
        proses!!.setOnClickListener(View.OnClickListener {
            ...
            if (value_no1!!.text.toString().toLowerCase() == "كَبِيْرَةٌ") {
                nilai = nilai + 20
            }
            if (value_no2!!.text.toString().toLowerCase() == "أَحْمَدْ") {
                nilai = nilai + 20
            }
            if (value_no3!!.text.toString().toLowerCase() == "مُدَرِّسَةٌ") {
                nilai = nilai + 20
            }
            if (value_no4!!.text.toString().toLowerCase() == "أُخْتٌ") {
                nilai = nilai + 20
            }
            if (value_no5!!.text.toString().toLowerCase() == "تَاجِرٌ") {
                nilai = nilai + 20
            }
            val i = Intent(this@LatihanTitik2Activity, ResultTitik2Activity::class.java)
    ...
    fun ShowDialog() {
        ...
        myDialog.setContentView(R.layout.bantuan_titik2_activity)
