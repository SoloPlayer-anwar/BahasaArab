...
import com.bahasaarab.bahasaarab.LatihanBab1.ResultTanyaActivity
import com.bahasaarab.bahasaarab.R

class LatihanTanya2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_latihan_tanya2)
        ...
        proses!!.setOnClickListener(View.OnClickListener {
            ...
            if (value_no1!!.text.toString().toLowerCase() == "نَعَم، أُسْرَتِيْ كَبِيْرَةٌ") {
                nilai = nilai + 20
            }
            if (value_no2!!.text.toString().toLowerCase() == "نَعَمْ، هِيَ مُدَرِّسَةٌ") {
                nilai = nilai + 20
            }
            if (value_no3!!.text.toString().toLowerCase() == "إِسْمُهُ مُوْسُى") {
                nilai = nilai + 20
            }
            if (value_no4!!.text.toString().toLowerCase() == "يَعْمَلُ أَبِيْ فِى جَامِعَةِ أَنْتَسَارِي الإِسْلاَمِيَّةِ الْحُكُوْمِيَّةِ") {
                nilai = nilai + 20
            }
            if (value_no5!!.text.toString().toLowerCase() == "جَدَّتِيْ فِى الْمَزْرَعَةِ") {
                nilai = nilai + 20
            }
            val i = Intent(this@LatihanTanya2Activity, ResultTanya2Activity::class.java)
    ...
    fun ShowDialog() {
        ...
        myDialog.setContentView(R.layout.tanya2_activity)
