...
import com.bahasaarab.bahasaarab.LatihanBab1.LatihanTitikActivity
import com.bahasaarab.bahasaarab.R
import kotlinx.android.synthetic.main.activity_result_gambar.*

class ResultTanya2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_tanya2)
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultTanya2Activity, LatihanTanya2Activity::class.java)
            startActivity(i)
            finish()
        })

        notif.setOnClickListener {
            val intent = Intent(this@ResultTanya2Activity,
                LatihanTitik2Activity::class.java)
