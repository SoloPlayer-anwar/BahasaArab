...
import com.bahasaarab.bahasaarab.LatihanBab2.ResultTitik2Activity
import com.bahasaarab.bahasaarab.R

class LatihanTitik3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_latihan_titik3)
        ...
        proses!!.setOnClickListener(View.OnClickListener {
            ...
            if (value_no1!!.text.toString().toLowerCase() == "طَالِبٌ") {
                nilai = nilai + 20
            }
            if (value_no2!!.text.toString().toLowerCase() == "أّدْرُسُ") {
                nilai = nilai + 20
            }
            if (value_no3!!.text.toString().toLowerCase() == "الصَّبَاحِ") {
                nilai = nilai + 20
            }
            if (value_no4!!.text.toString().toLowerCase() == "أَذْهَبُ") {
                nilai = nilai + 20
            }
            if (value_no5!!.text.toString().toLowerCase() == "مَسْجِدِ الْجَامِعَةِ") {
                nilai = nilai + 20
            }
            val i = Intent(this@LatihanTitik3Activity, ResultTitik3Activity::class.java)
    ...
    fun ShowDialog() {
        ...
        myDialog.setContentView(R.layout.bantuan_titik3_activity)
