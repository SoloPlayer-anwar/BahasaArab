...
class ResultTitik3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_titik3)
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultTitik3Activity, LatihanTitik3Activity::class.java)
            startActivity(i)
            finish()
        })
