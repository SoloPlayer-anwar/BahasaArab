...
import com.bahasaarab.bahasaarab.LatihanBab2.LatihanTanya2Activity
import com.bahasaarab.bahasaarab.LatihanBab2.LatihanTitik2Activity
import com.bahasaarab.bahasaarab.R
import kotlinx.android.synthetic.main.activity_result_gambar.*

class ResultTanya3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_tanya3)
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultTanya3Activity, LatihanTanya3Activity::class.java)
            startActivity(i)
            finish()
        })

        notif.setOnClickListener {
            val intent = Intent(this@ResultTanya3Activity,
                LatihanTitik3Activity::class.java)
