...
class ResultTitik5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_titik5)
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultTitik5Activity, LatihanTitik5Activity::class.java)
            startActivity(i)
            finish()
        })
