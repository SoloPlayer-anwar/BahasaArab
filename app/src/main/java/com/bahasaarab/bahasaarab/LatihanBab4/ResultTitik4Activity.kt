...
class ResultTitik4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_result_titik4)
        ...
        cobalagi!!.setOnClickListener(View.OnClickListener {
            val i = Intent(this@ResultTitik4Activity, LatihanTitik4Activity::class.java)
            startActivity(i)
            finish()
        })
