...
import com.bahasaarab.bahasaarab.LatihanBab3.ResultTitik3Activity
import com.bahasaarab.bahasaarab.R

class LatihanTitik4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_latihan_titik4)
        ...
        proses!!.setOnClickListener(View.OnClickListener {
            ...
            if (value_no1!!.text.toString().toLowerCase() == "الْمَقْعَدِ") {
                nilai = nilai + 20
            }
            if (value_no2!!.text.toString().toLowerCase() == "رُزًّا وَسَمَكًا وَعَصِيْرًا") {
                nilai = nilai + 20
            }
            if (value_no3!!.text.toString().toLowerCase() == "وَخُضَارًا وَدَجَاجَةً وَشَايًا") {
                nilai = nilai + 20
            }
            if (value_no4!!.text.toString().toLowerCase() == "دَفَعَ") {
                nilai = nilai + 20
            }
            if (value_no5!!.text.toString().toLowerCase() == "لِأَدَاءِ") {
                nilai = nilai + 20
            }
            val i = Intent(this@LatihanTitik4Activity, ResultTitik4Activity::class.java)
    ...
    fun ShowDialog() {
        ...
        myDialog.setContentView(R.layout.bantuan_titik4_activity)
